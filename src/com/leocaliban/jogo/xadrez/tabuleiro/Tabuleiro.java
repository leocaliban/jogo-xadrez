...
public class Tabuleiro {
	...
	public Tabuleiro(int linhas, int colunas) {
		if (linhas < 1 || colunas < 1) {
			throw new TabuleiroException("Erro ao criar o tabuleiro: � preciso haver pelo menos 1 linha e uma coluna.");
		}
		this.linhas = linhas;
	...
	public Peca buscarPecaPorCoordenadas(int linha, int coluna) {
		if (!posicaoExiste(linha, coluna)) {
			throw new TabuleiroException("Posi��o fora dos lim�tes do tabuleiro.");
		}
